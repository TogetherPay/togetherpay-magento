...
class SplitoffClient
{
     ...
     *
     * Will always be set to Basic for Splitoff API
     *
     * @var array|null
     */
    protected $auth;
     ...
     * @return SplitoffResponse         Formatted Splitoff Response Object
     */
    public function request($method = 'GET')
    {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $response_object = $objectManager->get('Splitoff\TogetherPay\Model\Adapter\Splitoff\SplitoffResponse');
     ...
     *
     * @param string $method            The HTTP Verb used (GET, POST)
     * @param SplitoffResponse $object  Splitoff Response object
     * @return SplitoffResponse         Formatted Splitoff Response Object
     * @throws Exception
     */
    protected function execute($method, $object)
    {
        ...
        try {
            ...
            if (empty($curl_response)) {
                throw new \Exception("Invalid Response from Splitoff API");
            }
            else {
            ...
            throw new \Exception("Something went wrong in Splitoff API Connection");
